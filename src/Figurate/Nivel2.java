...
class Nivel2 extends JPanel implements Runnable, MouseListener {

    Thread hiloNumeros = new Thread(this);
    ImageIcon fondo;
    String nombreImagen = "1231", NombreJugador = "1111";
//    Nombre para iimagenes
    String Etivar = "Evitar2.gif", coger1 = "Circulo2.png", coger2 = "Circulo3.png", FIGURAS1 = "Nivel2",FIGURAS2 = "Nivel3";
    ...
    public Nivel2(Jugador panelSup, Ventana vi) {
        this.J = panelSup;
        this.vi = vi;
        setLayout(null);
