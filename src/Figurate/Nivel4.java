...
class Nivel4 extends JPanel implements Runnable, MouseListener {

    Thread hiloNumeros = new Thread(this);
    ImageIcon fondo;
    String nombreImagen = "1231", NombreJugador = "1111";
//    Nombre para iimagenes
    String Etivar = "Evitar4.gif", coger1 = "Circulo2.png", coger2 = "Circulo3.png", FIGURAS1 = "Nivel4",FIGURAS2 = "Nivel1";
    ...
    public Nivel4(Jugador panelSup, Ventana vi) {
        this.J = panelSup;
        this.vi = vi;
        setLayout(null);
