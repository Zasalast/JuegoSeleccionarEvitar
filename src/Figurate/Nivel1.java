...
class Nivel1 extends JPanel implements Runnable, MouseListener {

    Thread hiloNumeros = new Thread(this);
    ImageIcon fondo;
    String nombreImagen = "1231", NombreJugador = "1111";
//    Nombre para iimagenes
    String Etivar = "Evitar.gif", coger1 = "Circulo2.png", coger2 = "Circulo3.png", FIGURAS1 = "Nivel1",FIGURAS2 = "Nivel4";
    ...
    public Nivel1(Jugador panelSup, Ventana vi) {
        this.J = panelSup;
        this.vi = vi;
        setLayout(null);
